...
// extern UInt32 l_node_cnt; 
extern uint64_t l_node_cnt[NODE_CNT];
...
extern UInt32 g_rsp_thread_cnt;
...
extern string g_pub_keys[NODE_CNT + CLIENT_NODE_CNT + REPLICA_CNT * NODE_CNT]; //stores public keys of other nodes
//CMAC
extern string cmacPrivateKeys[NODE_CNT + CLIENT_NODE_CNT + REPLICA_CNT * NODE_CNT ];
extern string cmacOthersKeys[NODE_CNT + CLIENT_NODE_CNT + REPLICA_CNT * NODE_CNT ];
// ED25519
extern CryptoPP::ed25519::Verifier verifier[NODE_CNT + CLIENT_NODE_CNT + REPLICA_CNT * NODE_CNT];
extern CryptoPP::ed25519::Signer signer;

// Receiving keys
extern uint64_t receivedKeys[NODE_CNT + CLIENT_NODE_CNT + REPLICA_CNT * NODE_CNT];
...
extern SpinLockMap<uint64_t, uint64_t> rep_responses_count[NODE_CNT];
extern SpinLockMap<uint64_t, ClientResponseMessage *> rep_responses_directory[NODE_CNT];
