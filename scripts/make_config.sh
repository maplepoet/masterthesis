...
echo -e "#define THREAD_CNT 6 // This Should be the sum of following thread count + protocol specifig threads" >> config.h
...
echo -e "#define CLIENT_THREAD_CNT 1" >> config.h
...
echo -e "// Hierarchical Setting " >> config.h
echo -e "#define Hierarchical false" >> config.h
echo -e "#define RSP_THREAD_CNT 1" >> config.h
echo -e "// Shard Setting " >> config.h
echo -e "#define Shard false" >> config.h
echo -e "#define Shard_CLUSTER_SIZE 4" >> config.h
echo -e "" >> config.h
...
echo -e "#define CPU_FREQ 3.0" >> config.h
...
echo -e "#define REQ_PER_QUERY 2" >> config.h
